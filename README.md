...
**Tech Lead @ Bettergy · Senior Software Engineer · Builder & Educator**

*Building multi-agent RAG systems, multi-tenant platforms, and AI-native engineering workflows — from clean production architecture to clear teaching.*
...
- 🔭 Building multi-agent RAG platforms with source-cited, real-time WebSocket streaming
- ⚡ Running production on Kubernetes + GitOps — 99.95% uptime, MTTR ~25 min, multiple daily releases
- 🤖 Re-shaped our engineering workflow around AI coding agents (Claude Code ships 30–40 PRs/week)
- 🎓 Pursuing an Executive Master's in Artificial Intelligence
- 🏆 1st Prize — UMA XXVI Spin-Off Contest
...
![RAG](https://img.shields.io/badge/RAG_+_Hybrid_Search-4B8BBE?style=flat-square)
...
![Bandit](https://img.shields.io/badge/Bandit-FFD343?style=flat-square&logo=python&logoColor=black)
![gitleaks](https://img.shields.io/badge/gitleaks-000000?style=flat-square)
...
![Visitors](https://komarev.com/ghpvc/?username=RafaFuentes4&style=flat-square&color=blue)
